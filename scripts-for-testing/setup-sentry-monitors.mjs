...
if (!APP_BASE_URL || APP_BASE_URL.includes("localhost") || APP_BASE_URL.includes("127.0.0.1")) {
  console.error(
    ...
    "   Sentry uptime monitors need to reach your app from the internet.\n" +
...
async function createMonitor(monitor) {
  const url = `${SENTRY_URL}/api/0/organizations/${ORG}/monitors/`;
...
async function main() {
  ...
  console.log("\n✨ Done! Visit https://sentry.io to see your monitors.");
}
